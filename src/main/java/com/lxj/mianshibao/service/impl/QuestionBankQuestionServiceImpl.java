...
import com.lxj.mianshibao.mapper.QuestionBankQuestionMapper;
...
//       //已存在题库中的题目id
        ...
        ThrowUtils.throwIf(CollUtil.isEmpty(validQuestionIdList)  ,ErrorCode.PARAMS_ERROR,"所有题目都已存在题库中");
